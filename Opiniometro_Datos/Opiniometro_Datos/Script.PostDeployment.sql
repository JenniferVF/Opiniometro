...
VALUES	('116720500', 'Jose Andrés', 'Mejías', 'Rojas', 'Desamparados de Alajuela.'),
		...
		('117893423', 'Jorge', 'Barquero', 'Villalobos', 'Cartago'),
		--Estudiantes
...
INSERT INTO Curso (Sigla, Nombre, Tipo,CodigoUnidad)
VALUES ('CI1240', 'Desarrolo de Apliaciones de Software', 1,'UC-023874')
...
values (2018, 1), (2018, 2), (2019, 1), (2020, 1);
...
--VALUES ('CI1330', 2, 2018, 1)
	...
	((select c.Sigla from Curso c where c.Sigla = 'CI1240'), 2, 2020, 1),
...
VALUES  ('2017-4-5', '131313', '100000003', '100000002', 2017, 2, 1, 'CI1330', 1),
		...
		('2020-4-5', '121212', '100000003', '117893423', 2020, 1, 2, 'CI1240', 1),
		('2020-3-6', '121212', '100000004', '117893423', 2020, 1, 2, 'CI1240', 1),
		('2020-4-18', '121212', '100000005', '117893423', 2020, 1, 2, 'CI1240', 1);
...
VALUES	('PRE101', '131313', 'Opinion general del curso', 'Evaluación de Profesores', 1, 1),
		...
		('PRE101', '121212', 'Opinion general del curso', 'Evaluación de Profesores', 1, 1),
		('PRE202', '121212', 'Opinion general del curso', 'Evaluación de Profesores', 1, 3),
		('PRE303', '121212', 'Evaluación de aspectos reglamentarios del profesor', 'Evaluación de Profesores', 2, 1),	
		('PRE404', '121212', 'Evaluación de aspectos reglamentarios del profesor', 'Evaluación de Profesores', 2, 2);
...
VALUES	('PRE303', 'Evaluación de aspectos reglamentarios del profesor', '2017-4-5', '131313', '100000003', '100000002', 2017, 2, 1, 'CI1330', 'NS/NR', 'Nunca tuvimos que reponer clases'),
		...
		('PRE303', 'Evaluación de aspectos reglamentarios del profesor', '2020-4-18', '121212', '100000005', '117893423', 2020, 1, 2, 'CI1240', 'Sí', 'Me repuso una clase a la que falte'),
		('PRE404', 'Evaluación de aspectos reglamentarios del profesor', '2020-4-18', '121212', '100000005', '117893423', 2020, 1, 2, 'CI1240', 'Sí', 'Sí se reviso'),
		('PRE101', 'Opinion general del curso', '2020-4-18', '121212', '100000005', '117893423', 2020, 1, 2, 'CI1240', '', 'Entretenido'),
		('PRE202', 'Opinion general del curso', '2020-4-18', '121212', '100000005', '117893423', 2020, 1, 2, 'CI1240', 'Muy buena profesora', ''),
