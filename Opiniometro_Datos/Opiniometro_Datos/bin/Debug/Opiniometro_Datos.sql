...
:setvar DefaultDataPath "C:\Users\Adrian Vargas\AppData\Local\Microsoft\VisualStudio\SSDT\Opiniometro_Datos"
:setvar DefaultLogPath "C:\Users\Adrian Vargas\AppData\Local\Microsoft\VisualStudio\SSDT\Opiniometro_Datos"
...
IF EXISTS (select top 1 1 from [dbo].[Tiene_Grupo_Formulario])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'The following operation was generated from a refactoring log file 592e99c3-1254-4de1-b05d-9f17f4093372';

PRINT N'Rename [dbo].[Tiene_Grupo_Formulario].[Numero] to n';


GO
EXECUTE sp_rename @objname = N'[dbo].[Tiene_Grupo_Formulario].[Numero]', @newname = N'n', @objtype = N'COLUMN';


GO
PRINT N'The following operation was generated from a refactoring log file dc6a0f78-92da-4e59-adcc-a8bd5f3c6367';

PRINT N'Rename [dbo].[Tiene_Grupo_Formulario].[SiglaCurso] to Numero';


GO
EXECUTE sp_rename @objname = N'[dbo].[Tiene_Grupo_Formulario].[SiglaCurso]', @newname = N'Numero', @objtype = N'COLUMN';
...
GO
PRINT N'The following operation was generated from a refactoring log file cd123148-89bb-49bf-8116-5668d23b361a';

PRINT N'Rename [dbo].[Tiene_Grupo_Formulario].[n] to SiglaCurso';


GO
EXECUTE sp_rename @objname = N'[dbo].[Tiene_Grupo_Formulario].[n]', @newname = N'SiglaCurso', @objtype = N'COLUMN';
...
GO
PRINT N'Dropping [dbo].[FK_Tie_Gru]...';


GO
ALTER TABLE [dbo].[Tiene_Grupo_Formulario] DROP CONSTRAINT [FK_Tie_Gru];


GO
PRINT N'Dropping [dbo].[FK_Tie_Fec]...';


GO
ALTER TABLE [dbo].[Tiene_Grupo_Formulario] DROP CONSTRAINT [FK_Tie_Fec];


GO
PRINT N'Dropping [dbo].[FK_Tie_For]...';


GO
ALTER TABLE [dbo].[Tiene_Grupo_Formulario] DROP CONSTRAINT [FK_Tie_For];


GO
PRINT N'Starting rebuilding table [dbo].[Tiene_Grupo_Formulario]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Tiene_Grupo_Formulario] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Tiene1] PRIMARY KEY CLUSTERED ([SiglaCurso] ASC, [Numero] ASC, [Anno] ASC, [Ciclo] ASC, [Codigo] ASC, [FechaInicio] ASC, [FechaFinal] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Tiene_Grupo_Formulario])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Tiene_Grupo_Formulario] ([SiglaCurso], [Numero], [Anno], [Ciclo], [Codigo], [FechaInicio], [FechaFinal])
        SELECT   [SiglaCurso],
                 [Numero],
                 [Anno],
                 [Ciclo],
                 ...
                 [FechaFinal]
        FROM     [dbo].[Tiene_Grupo_Formulario]
        ORDER BY [SiglaCurso] ASC, [Numero] ASC, [Anno] ASC, [Ciclo] ASC, [Codigo] ASC, [FechaInicio] ASC, [FechaFinal] ASC;
    END

DROP TABLE [dbo].[Tiene_Grupo_Formulario];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Tiene_Grupo_Formulario]', N'Tiene_Grupo_Formulario';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_Tiene1]', N'PK_Tiene', N'OBJECT';
